...
public static class ProfileStorage
{
    ...
    {
        s_currentProfile = new ProfileData(profileName, true, 0);
    ...
    public static void LoadProfile(string filename)
    {
        ...
        int level = ProfileStorage.s_currentProfile.level;
        SceneManager.LoadScene(level + 3);
    }

    // =====================================================
    public static void StorePlayerProfile()
    {
        //s_currentProfile.x = player.transform.position.x;
        //s_currentProfile.y = player.transform.position.y;
        s_currentProfile.level = SceneManager.GetActiveScene().buildIndex - 3;
